/* I make bug fix for strrep which make un expected substitution for 2d matrix of character 
 the way of sorting the matrix is the problem Example:
 ...
 c(2)
 ans = G
which means that the matrix sorted as a long 1d matrix ["HGWO..."]which is completely worng as the function can't make any replacement so I try to make
 a some change to strrep which to split the 2d char matrix into 2 matrices
 and add them so they became a two wright strings then make the replacement 
correctly.  */

commit 2e6fe69c2aab56223e150d41e6cf8f35627719fe
Author: abdelrhman323 <abduadell37@gmail.com>
Date:   Sat Mar 21 23:35:13 2020 +0200

    first patch by strrep bug report

diff --git a/patch.txt b/patch.txt
new file mode 100644
index 0000000..e5f1654
--- /dev/null
+++ b/patch.txt
@@ -0,0 +1,489 @@
+commit 0613258f6c114678b4b4dd55b8d7d700a027cad4
+Author: abdelrhman323 <abduadell37@gmail.com>
+Date:   Sat Mar 21 23:25:28 2020 +0200
+
+    fix bug strreplace.txt
+
+diff --git a/strreplace.txt b/strreplace.txt
+new file mode 100644
+index 0000000..56620f5
+--- /dev/null
++++ b/strreplace.txt
+@@ -0,0 +1,477 @@
++commit 8d7453e1896702e87318738b2f115d1e689fb2fc
++Author: abdelrhman323 <abduadell37@gmail.com>
++Date:   Sat Mar 21 22:55:17 2020 +0200
++
++    fix bug strreplace.cc
++
++diff --git a/strreplace.cc b/strreplace.cc
++new file mode 100644
++index 0000000..de3388e
++--- /dev/null
+++++ b/strreplace.cc
++@@ -0,0 +1,465 @@
+++/*
...
+++           if(!overlaps){
+++            
+++          for (octave_idx_type i = 1; i < np; i+=2)
+++          { a[i] =y[i];
+++            b[i] =y[i+1];
+++          }    
+++               octave_value z;
